...
namespace GUX.Core
{
    ...
    public class ListViewButtonColumn : ListViewColumn
    {
        ...
        public override void Draw(DrawListViewSubItemEventArgs e)
        {
            ...
            g.DrawRectangle(Pens.Red, ListView.ClientRectangle);
            ...
            {
                ButtonRenderer.DrawButton(g, e.Bounds, e.SubItem.Text, Font, true, PushButtonState.Hot);
                _hot = e.Bounds;
            }
            else
            {
                ButtonRenderer.DrawButton(g, e.Bounds, e.SubItem.Text, Font, false, PushButtonState.Default);
            }
        }
    }
}
